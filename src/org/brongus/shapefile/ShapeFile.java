...
public class ShapeFile {
    ...
    public final static String DEFAULT_SHAPEFILE_LOCATION = "/data/shapefiles/usa";
    public final static String DEFAULT_SHAPEFILE = "states";
    ...
    public ShapeFile(String path, String filename) throws Exception {
        ...
        initShapeFiles(dir, filename);
    }

    private void initShapeFiles(File dir, String filename) throws Exception {
    ...
    public ShapeFile() throws Exception {
        String curDir;
        File dir;

        curDir = System.getProperty("user.dir");
        dir = new File(curDir + DEFAULT_SHAPEFILE_LOCATION);

        initShapeFiles(dir, DEFAULT_SHAPEFILE);
    }
    ...
    /**
     * same as:
     * {@link org.brongus.shapefile.files.shp.SHP_Header#getBoundingBox()}
     *
    ...
    /**
     * same as: {@link org.brongus.shapefile.files.dbf.DBF_File#getContent()}
     *
